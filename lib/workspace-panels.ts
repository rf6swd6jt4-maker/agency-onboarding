...
export const WORKSPACE_PANELS = [
    ...
    { key: "communications", label: "Communications", route: "communications", capability: "communications.manage", minimumRole: "admin", description: "Relationship communication summaries", keywords: ["messages", "chat", "whatsapp", "communication"] },
