...
import { createButtonBlock, createChecklistBlock, createEstimateBlock, createFormBlock, createVideoBlock, stepEstimate } from "@/lib/onboarding/block-definition"
...
export function VisualBuilderCanvas({
    ...
    function insertBlock(index: number, kind: "estimate" | "checklist" | "form" | "video" | "button") {
        if (kind === "form" && step.blocks.some((block) => block.kind === "form")) return
