...
export function WhyWeAskCard({ children }: WhyWeAskCardProps) {
    return (
        <div className="rounded-2xl border-l-4 border-[var(--onboarding-accent,#F0B429)] bg-[color-mix(in_srgb,var(--onboarding-accent,#F0B429)_12%,var(--onboarding-surface,#FFFFFF))] p-4 sm:p-5">
