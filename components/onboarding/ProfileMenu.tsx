    ...
    return (
        <div ref={menuRef} className="relative">
            <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-black/10 bg-[var(--onboarding-page,#F8F7F3)] text-sm font-semibold text-[var(--onboarding-primary,#1E3A5F)] transition hover:border-[var(--onboarding-primary,#1E3A5F)] focus:outline-none focus:ring-4 focus:ring-black/5"
