...
import { OnboardingBuilderLauncher } from "@/components/onboarding-builder/OnboardingBuilderWindowControls"
...
export function OnboardingSettings({ workspaceSlug, schemaReady }: {
    ...
    return <div className="space-y-5">
        <section className="flex flex-col gap-4 rounded-2xl border border-neutral-700 bg-gradient-to-br from-neutral-900 to-black p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
            ...
            <OnboardingBuilderLauncher workspaceSlug={workspaceSlug} href={`/${workspaceSlug}/onboarding-builder`} className="inline-flex min-h-10 shrink-0 items-center justify-center rounded-lg bg-white px-4 text-sm font-medium text-black" />
        </section>
