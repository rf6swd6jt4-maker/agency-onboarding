...
export function MessageReactionActions({ currentEmoji, recentEmoji, onReact, onRecentEmoji, side }: {
    ...
    return <div className="relative">
        ...
        {customOpen ? <form onSubmit={(event) => { event.preventDefault(); submitCustom() }} className={`absolute bottom-12 flex w-64 gap-2 rounded-xl border border-neutral-800 bg-neutral-950 p-2 text-white shadow-2xl lg:bottom-10 ${side === "right" ? "right-0" : "left-0"}`}>
