...
export function MessageMediaLightbox({ media, onClose }: { media: MessageMediaPreview | null; onClose: () => void }) {
    ...
    return <div role="dialog" aria-modal="true" aria-label="Image preview" onPointerDown={(event) => { if (event.target === event.currentTarget) onClose() }} className="fixed inset-0 z-[180] flex items-center justify-center bg-black/95 p-3 sm:p-8">
