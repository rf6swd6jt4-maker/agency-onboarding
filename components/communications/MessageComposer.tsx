        ...
        >
            ...
            <div className="relative min-w-0 flex-1">
                ...
                <textarea
                    ...
                    className="relative h-11 min-h-11 w-full resize-none overflow-y-hidden bg-transparent py-2.5 text-base leading-6 outline-none transition-[height] duration-[180ms] ease-[cubic-bezier(0.25,0.1,0.25,1)] motion-reduce:transition-none disabled:cursor-not-allowed lg:h-9 lg:min-h-9 lg:py-2 lg:text-sm lg:leading-5"
                />
            </div>
