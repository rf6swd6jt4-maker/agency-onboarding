create or replace function public.client_portal_messages(
    p_workspace_id uuid,
...
revoke all on function public.client_portal_messages(uuid, uuid, timestamptz, integer) from public, anon, authenticated;
grant execute on function public.client_portal_messages(uuid, uuid, timestamptz, integer) to service_role;
