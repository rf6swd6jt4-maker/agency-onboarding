...
export default async function AdminActivityPage({ params, searchParams }: PageProps) {
    ...
    return <main className="min-h-screen bg-neutral-950 px-4 pb-8 text-white sm:px-6">
        ...
        <div className="mx-auto max-w-7xl pt-5">
            ...
            <header><p className="text-xs uppercase tracking-[0.18em] text-neutral-500">Private workspace operations</p><h1 className="mt-2 text-2xl font-semibold">Activity Console</h1><p className="mt-2 max-w-3xl text-sm leading-6 text-neutral-400">A workspace-wide operational trail for onboarding, billing, communications, Lead Gen, integrations, and Gantt automation.</p></header>
