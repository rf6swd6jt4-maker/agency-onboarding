...
test("the portal message foundation is token scoped and strips staff-only communication data", () => {
    ...
    assert.doesNotMatch(portalMessagesRoute, /export async function POST/u)
})
